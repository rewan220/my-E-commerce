              ...
              <div class="card shadow-hover h-100" >
                ...
                <div class="card-body ">
                  ...
                  @if($product->onSale)
                    ...
                    <p class="text-orange py-0 my-0 h5">{{number_format($product->sale_price)}}</p>
                  @else
                    <p class="text-orange py-0 my-0 h5">{{number_format($product->price)}}</p>
                  @endif
                </div>
          ...
          <div class="row">
            <div class="col-sm-8 col-md-6 col-6 mx-auto">
              <div class="text-center">
                ...
                <img src="{{asset('images/demo/empty.jpg')}}" class="w-100" alt="">
              </div>
            </div>
          </div>
          @endif
