          ...
          <div class="row align-items-center">
              <div class="col-lg-3 col-sm-6 col-md-3 col-5"> 
                <a href="{{route('shop.index')}}" class="brand-wrap" data-abc="true">
                      ...
                      <span class="logo" style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Mira Shop</span> 
                </a> </div>
              ...
              <div class="col-lg-3 col-sm-6 col-md-3 col-xl-4 col-7">
                  <div class="d-flex justify-content-end">
                    ...
                    <a class="nav-link nav-user-img text-white" href="{{route('register')}}"> REGISTER</a>
                    @endguest
                    @auth
