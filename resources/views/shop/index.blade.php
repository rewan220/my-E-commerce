      ...
      <div class="col-6 col-sm-4 col-md-2 p-2">
        <div class="card shadow-hover h-100" >
          ...
          <div class="card-body ">
            ...
            <br>
            <small class="line-through"> {{number_format($item->product->price)}}</small>
            <p class="product-price"> {{number_format($item->flash_price)}}</p>
          </div>
        ...
        <div class="card shadow-hover h-100" >
          ...
          <div class="card-body ">
            ...
            @if($product->onSale)
              ...
              <p class="product-price">{{number_format($product->sale_price)}}</p>
            @else
