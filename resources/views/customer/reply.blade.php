          ...
          <div class="my-4">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-9">
                ...
                <p>Price : <span>{{number_format($question->product->price)}}</span></p>
                <p>Sale Price :{{number_format($question->product->sale_price)}} </p>
                @else
                <p>Price :{{number_format($question->product->price)}} </p>
                @endif
              </div>
            </div>
          </div>
